...
export default function Index() {
    ...
    const dropboxBtn = usePageButtons('dropboxBtn', { module: 'Task', settingKey: 'Dropbox Task' });
                    ...
                    <TooltipProvider>
                        <Tooltip delayDuration={0}>
                            <TooltipTrigger asChild>
                                <Button variant="ghost" size="sm" onClick={() => openModal('view', task)} className="h-8 w-8 p-0 text-green-600 hover:text-green-700">
                                                        ...
                                                        <TooltipProvider>
                                                            {auth.user?.permissions?.includes('view-project-task') && (
                                                                <Tooltip delayDuration={300}>
                                                                    <TooltipTrigger asChild>
                                                                        <Button variant="ghost" size="sm" onClick={() => openModal('view', task)} className="h-8 w-8 p-0 text-green-600">
                                                                            <Eye className="h-4 w-4" />
                                                                        </Button>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
