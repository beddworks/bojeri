...
export default function BugKanban() {
    ...
    useFlashMessages();
    const googleDriveButtons = usePageButtons('googleDriveBtn', { module: 'Project Bug', settingKey: 'GoogleDrive Bug' });
    const oneDriveButtons = usePageButtons('oneDriveBtn', { module: 'Bug', settingKey: 'OneDrive Bug' });
    const dropboxBtn = usePageButtons('dropboxBtn', { module: 'Bug', settingKey: 'Dropbox Bug' });
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                {auth.user?.permissions?.includes('delete-project-bug') && (
                                    <DropdownMenuItem onClick={() => openDeleteDialog(task.id)} className="text-red-600 focus:text-red-600">
