...
import { Plus, Edit as EditIcon, Trash2, Eye, Users as UsersIcon, User as UserIcon, Lock, Download, FileImage } from "lucide-react";
...
export default function Index() {
    ...
    useFlashMessages();
    const googleDriveButtons = usePageButtons('googleDriveBtn', { module: 'Employee', settingKey: 'GoogleDrive Employee' });
    const oneDriveButtons = usePageButtons('oneDriveBtn', { module: 'Employee', settingKey: 'OneDrive Employee' });
    const dropboxButtons = usePageButtons('dropboxBtn', { module: 'Employee', settingKey: 'Dropbox Employee' });
                                            ...
                                            <div className="p-4 bg-gradient-to-r from-primary/5 to-transparent border-b flex-shrink-0">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        ...
                                                        {auth.user?.permissions?.includes('view-employees') ? (
                                                            <h3 className="text-xs font-medium text-blue-600 hover:text-blue-700 cursor-pointer" onClick={() => router.get(route('hrm.employees.show', employee.id))}>
                                            ...
                                            <div className="p-4 flex-1 min-h-0">
                                                <div className="grid grid-cols-1 gap-4 mb-3">
                                                    <div className="text-xs min-w-0">
                                                        ...
                                                        <p className="font-medium text-xs break-all">{employee.user?.email || '-'}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-4 mb-3">
                                                 ...
                                                 <div className="grid grid-cols-2 gap-4 mb-3">
                                                    <div className="text-xs min-w-0">
                                                        ...
                                                        <p className="font-medium text-xs">{formatDate(employee.date_of_birth) || '-'}</p>
                                                    </div>
                                                    <div className="text-xs min-w-0">
