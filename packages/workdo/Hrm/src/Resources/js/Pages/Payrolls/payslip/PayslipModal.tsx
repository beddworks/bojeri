                        ...
                        <CardContent className="space-y-3">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="font-medium text-green-600">{payrollEntry.paid_leave_days} {t('days')}</span>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="font-medium text-red-600">{payrollEntry.unpaid_leave_days}  {t('days')}</span>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="font-medium text-yellow-600">{payrollEntry.half_days}  {t('days')}</span>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="font-medium text-red-600">{payrollEntry.absent_days} {t('days')}</span>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between text-lg">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            ({t('Basic + Allowances + Overtimes')}) - {t('Leave Deductions')}
                                        </p>
                                    </div>
                                ...
                                <div className="flex justify-between text-xl">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            {t('Gross Pay')} - ({t('Other Deductions + Loans')})
                                        </p>
                                    </div>
