            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <Repeater
                            fields={[
                                { name: 'title', label: t('Benefit Title'), type: 'text', placeholder: t('Complete Project Management'), required: true },
                                { name: 'description', label: t('Benefit Description'), type: 'textarea', placeholder: t('Organize and track all your projects in one place with powerful task management tools'), required: true }
                            ]}
