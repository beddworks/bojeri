            ...
            [
                ...
                'content' => '<div class="space-y-8">
                    <div class="text-center">
                        ...
                        <p class="text-lg text-gray-600 max-w-3xl mx-auto">We are dedicated to providing innovative business solutions that help companies streamline their operations and achieve their goals.</p>
                    </div>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-4">Our Mission</h3>
                            <p class="text-gray-600 leading-relaxed">To empower businesses with cutting-edge technology solutions that drive growth, efficiency, and success in today\'s competitive marketplace.</p>
                        </div>
                        <div class="bg-gray-100 rounded-lg p-8">
                            <h3 class="text-2xl font-semibold text-gray-900 mb-4">Our Vision</h3>
                            <p class="text-gray-600 leading-relaxed">To be the leading provider of comprehensive business management solutions that transform how companies operate and succeed.</p>
                        </div>
                    </div>
                    
                    <div class="rounded-lg p-8" style="background-color: color-mix(in srgb, var(--color-primary) 5%, white);">
                        <h3 class="text-2xl font-semibold text-gray-900 mb-6 text-center">Why Choose Us?</h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="text-center">
                                ...
                                <p class="text-gray-600 text-sm">Our experienced professionals are dedicated to your success.</p>
                            </div>
                            <div class="text-center">
                                <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style="background-color: var(--color-primary);">
                                    <span class="text-white font-bold text-xl">2</span>
                                </div>
                                <h4 class="font-semibold text-gray-900 mb-2">Innovative Solutions</h4>
                                <p class="text-gray-600 text-sm">Cutting-edge technology tailored to your business needs.</p>
                            </div>
                            <div class="text-center">
                                <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style="background-color: var(--color-primary);">
                                ...
                                <p class="text-gray-600 text-sm">Round-the-clock assistance whenever you need it.</p>
                            </div>
                        </div>
                    </div>
                </div>',
            ...
            [
                ...
                'content' => '<div class="space-y-6">
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed">This Privacy Policy describes how we collect, use, and protect your information when you use our service.</p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <p class="text-gray-600">If you have any questions about this Privacy Policy, please contact us at privacy@example.com</p>
                    </div>
                </div>',
            ...
            [
                ...
                'content' => '<div class="space-y-6">
                    ...
                    <div class="rounded-lg p-6" style="background-color: color-mix(in srgb, var(--color-primary) 5%, white);">
                        ...
                        <p class="text-gray-600">If you have any questions about these Terms of Service, please contact us at legal@example.com</p>
                    </div>
                </div>',
                ...
                'content' => '<div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white border rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">What is BOJERI?</h3>
                            <p class="text-gray-600 leading-relaxed">BOJERI is a comprehensive business management platform that helps companies streamline their operations, manage projects, and improve productivity through integrated tools and modules.</p>
                        </div>
                        ...
                        <div class="bg-white border rounded-lg p-6">
                            ...
                            <p class="text-gray-600 leading-relaxed">Yes! BOJERI offers extensive customization options including custom fields, workflows, dashboards, and integrations with third-party tools.</p>
                        </div>
                    </div>
