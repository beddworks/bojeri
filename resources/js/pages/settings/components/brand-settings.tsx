...
export default function BrandSettings({ userSettings, auth }: BrandSettingsProps) {
  ...
  const [settings, setSettings] = useState<BrandSettings>({
    ...
    titleText: userSettings?.titleText || 'BOJERI',
    footerText: userSettings?.footerText || '© BOJERI. All rights reserved.',
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">{t('Recommended: 100px × 30px')}</p>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      placeholder={t('© BOJERI. All rights reserved.')}
                      disabled={!canEdit}
                    />
                    <p className="text-xs text-muted-foreground">
